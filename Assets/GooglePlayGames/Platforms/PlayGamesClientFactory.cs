...
namespace GooglePlayGames
{
    ...
    internal class PlayGamesClientFactory
    {
            ...
            PlayGamesClientConfiguration config)
        {
            ...
            {
                Logger1.d("Creating IPlayGamesClient in editor, using DummyClient.");
                return new GooglePlayGames.BasicApi.DummyClient();
            }
#if (UNITY_ANDROID || (UNITY_IPHONE && !NO_GPGS))
            Logger1.d("Creating real IPlayGamesClient");
            return new GooglePlayGames.Native.NativeClient(config);
#else
            Logger1.d("Cannot create IPlayGamesClient for unknown platform, returning DummyClient");
            return new GooglePlayGames.BasicApi.DummyClient();
#endif
        }
    }
