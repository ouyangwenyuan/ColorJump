...
namespace GooglePlayGames.Native.PInvoke
{
    ...
    static class Callbacks
    {
        ...
        {
            Logger1.d("Received UI callback: " + status);
        };
        ...
        private static T IntPtrToCallback<T>(IntPtr handle, bool unpinHandle) where T : class
        {
            ...
            {
                Logger1.e("GC Handle pointed to unexpected type: " + gcHandle.Target.ToString() +
                    ". Expected " + typeof(T));
                throw e;
            }
            finally
        ...
        {
            Logger1.d("Showing UI Internal callback: " + status);
            ...
            {
                Logger1.e("Error encountered executing InternalShowAllUICallback. " +
        ...
        {
            Logger1.d("Entering internal callback for " + callbackName);
            ...
            {
                Logger1.e("Error encountered executing " + callbackName + ". " +
                    "Smothering to avoid passing exception into Native: " + e);
            }
        }
                                                        ...
                                                        T param1, IntPtr param2, IntPtr userData)
        {
            ...
            {
                Logger1.e("Error encountered converting " + callbackName + ". " +
                    "Smothering to avoid passing exception into Native: " + e);
                return;
            }

            Logger1.d("Internal Callback converted to action");
            if (callback == null)
            {
                return;
            }
