...
namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class TurnBasedManager
    {
        ...
        internal void AcceptInvitation(MultiplayerInvitation invitation,
                                   Action<TurnBasedMatchResponse> callback)
        {
            Logger1.d("Accepting invitation: " + invitation.AsPointer().ToInt64());
        ...
        {
            Logger1.d("InternalMultiplayerStatusCallback: " + status);
            ...
            {
                Logger1.e("Error encountered executing InternalMultiplayerStatusCallback. " +
