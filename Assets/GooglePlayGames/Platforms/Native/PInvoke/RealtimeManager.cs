...
namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class RealtimeManager
    {
        ...
        {
            Logger1.d("Entering internal callback for InternalLeaveRoomCallback");
            ...
            {
                Logger1.e("Error encountered executing InternalLeaveRoomCallback. " +
        ...
        internal static void InternalSendReliableMessageCallback(Status.MultiplayerStatus response,
                                                             IntPtr data)
        {
            Logger1.d("Entering internal callback for InternalSendReliableMessageCallback " + response);
            ...
            {
                Logger1.e("Error encountered executing InternalSendReliableMessageCallback. " +
                    "Smothering to avoid passing exception into Native: " + e);
            }
        }
