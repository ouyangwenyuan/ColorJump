...
namespace Unibill.Impl {
    public class BillerFactory {
        ...
        private ILogger1 logger;
        private IStorage storage;
        private IRawBillingPlatformProvider platformProvider;
        private IUtil util;
        private UnibillConfiguration config;

        public BillerFactory(IResourceLoader resourceLoader, ILogger1 logger, IStorage storage, IRawBillingPlatformProvider platformProvider, UnibillConfiguration config, IUtil util) {
