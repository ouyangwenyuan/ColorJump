...
namespace Unibill.Impl
{
	public class RemoteConfigManager
	{
        ...
        public RemoteConfigManager (IResourceLoader loader, IStorage storage, ILogger1 logger, RuntimePlatform platform, List<ProductDefinition> runtimeProducts = null) {
		...
		private void refreshCachedConfig(string url, ILogger1 logger) {
