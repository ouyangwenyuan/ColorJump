...
namespace Unibill.Impl {
    public class AmazonAppStoreBillingService : IBillingService {
        ...
        public AmazonAppStoreBillingService(IRawAmazonAppStoreBillingInterface amazon, ProductIdRemapper remapper, UnibillConfiguration db, TransactionDatabase tDb, ILogger1 logger) {
